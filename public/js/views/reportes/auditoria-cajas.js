      ...
      : rows
          .map((p) => {
            ...
            return `<tr>
              ...
              <td class="text-end">${this.escapeHtml(Number(m.unidades).toLocaleString('es-SV', { maximumFractionDigits: 3 }))}</td>
            ...
            <tbody>
              <tr>
                ...
                <td class="text-end fw-semibold">${this.escapeHtml(
                  totU.toLocaleString('es-SV', { maximumFractionDigits: 3 })
                )}</td>
  ...
  buildProductosPrintSection(money) {
    ...
    const fmtU = (v) =>
      PrintReport.escapeHtml(
        Number(v || 0).toLocaleString('es-SV', { maximumFractionDigits: 3 })
      );
    let totU = 0;
    let totCon = 0;
    let totCre = 0;
